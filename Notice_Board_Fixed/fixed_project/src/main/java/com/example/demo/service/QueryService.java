...
public class QueryService {
    ...
    */
    ...
    //createdAt @PrePersist se set hoga, manually set karne ki zaroorat nahi
    ...
    */
    ...
    // Manually set karo, @PreUpdate pe depend mat karo
    public Query replyToQuery(Long id, String replyMessage, String repliedBy) {
        ...
        query.setStatus(QueryStatus.REPLIED); // Fix 1: REPLIED use karo
